...
var $author$project$Main$init = F3(
	function (flags, url, key) {
		var authToken = function () {
			var _v0 = _Utils_Tuple2(flags.token, flags.refreshToken);
			if ((_v0.a.$ === 'Just') && (_v0.b.$ === 'Just')) {
				var token = _v0.a.a;
				var refreshToken = _v0.b.a;
				return $elm$core$Maybe$Just(
		...
		return _Utils_Tuple2(
			{
				authToken: authToken,
				confirmForgotPasswordModel: $author$project$Page$ConfirmForgotPassword$init,
				...
				windowSize: _Utils_Tuple2(flags.windowWidth, flags.windowHeight)
			},
			A2(
...
var $author$project$Main$ApiResponse = F2(
	function (a, b) {
		return {$: 'ApiResponse', a: a, b: b};
	});
var $author$project$Api$AuthRequest = function (a) {
	return {$: 'AuthRequest', a: a};
};
...
var $author$project$Proto$Api$RequestConfirmSignUp = function (a) {
	return {$: 'RequestConfirmSignUp', a: a};
};
...
var $author$project$Proto$Api$RequestSignUp = function (a) {
	return {$: 'RequestSignUp', a: a};
};
var $author$project$Main$PrevRequest = function (a) {
	return {$: 'PrevRequest', a: a};
};
...
var $tiziano88$elm_protobuf$Protobuf$requiredFieldEncoder = F4(
	function (name, encoder, _default, v) {
		return _Utils_eq(v, _default) ? $elm$core$Maybe$Nothing : $elm$core$Maybe$Just(
			_Utils_Tuple2(
				name,
				encoder(v)));
	});
var $elm$json$Json$Encode$string = _Json_wrap;
var $author$project$Proto$Api$confirmForgotPasswordRequestEncoder = function (v) {
	return $elm$json$Json$Encode$object(
		A2(
			...
			_List_fromArray(
				[
					A4($tiziano88$elm_protobuf$Protobuf$requiredFieldEncoder, 'username', $elm$json$Json$Encode$string, '', v.username),
					A4($tiziano88$elm_protobuf$Protobuf$requiredFieldEncoder, 'password', $elm$json$Json$Encode$string, '', v.password),
					A4($tiziano88$elm_protobuf$Protobuf$requiredFieldEncoder, 'confirmationCode', $elm$json$Json$Encode$string, '', v.confirmationCode)
				])));
};
var $author$project$Proto$Api$confirmSignUpRequestEncoder = function (v) {
	return $elm$json$Json$Encode$object(
		A2(
			$elm$core$List$filterMap,
			$elm$core$Basics$identity,
...
var $author$project$Proto$Api$forgotPasswordRequestEncoder = function (v) {
	return $elm$json$Json$Encode$object(
		A2(
			$elm$core$List$filterMap,
			$elm$core$Basics$identity,
...
var $author$project$Proto$Api$resendConfirmationCodeRequestEncoder = function (v) {
	return $elm$json$Json$Encode$object(
		A2(
			$elm$core$List$filterMap,
			$elm$core$Basics$identity,
...
var $author$project$Proto$Api$signInRequestEncoder = function (v) {
	return $elm$json$Json$Encode$object(
		A2(
			$elm$core$List$filterMap,
			$elm$core$Basics$identity,
...
var $author$project$Proto$Api$signUpRequestEncoder = function (v) {
	return $elm$json$Json$Encode$object(
		A2(
			$elm$core$List$filterMap,
			$elm$core$Basics$identity,
			_List_fromArray(
				[
					A4($tiziano88$elm_protobuf$Protobuf$requiredFieldEncoder, 'username', $elm$json$Json$Encode$string, '', v.username),
					A4($tiziano88$elm_protobuf$Protobuf$requiredFieldEncoder, 'email', $elm$json$Json$Encode$string, '', v.email),
					A4($tiziano88$elm_protobuf$Protobuf$requiredFieldEncoder, 'password', $elm$json$Json$Encode$string, '', v.password)
				])));
};
var $author$project$Proto$Api$tokenRefreshRequestEncoder = function (v) {
	return $elm$json$Json$Encode$object(
		A2(
			$elm$core$List$filterMap,
			$elm$core$Basics$identity,
			_List_fromArray(
				[
					A4($tiziano88$elm_protobuf$Protobuf$requiredFieldEncoder, 'refreshToken', $elm$json$Json$Encode$string, '', v.refreshToken)
				])));
};
var $author$project$Proto$Api$authRequestSelectEncoder = function (v) {
	switch (v.$) {
		case 'AuthRequestSelectUnspecified':
			return $elm$core$Maybe$Nothing;
		case 'RequestSignUp':
			var x = v.a;
			return $elm$core$Maybe$Just(
				_Utils_Tuple2(
					'requestSignUp',
					$author$project$Proto$Api$signUpRequestEncoder(x)));
		case 'RequestConfirmSignUp':
			var x = v.a;
			return $elm$core$Maybe$Just(
				_Utils_Tuple2(
					'requestConfirmSignUp',
					$author$project$Proto$Api$confirmSignUpRequestEncoder(x)));
		case 'RequestResendConfirmationCode':
			var x = v.a;
			return $elm$core$Maybe$Just(
				_Utils_Tuple2(
					'requestResendConfirmationCode',
					$author$project$Proto$Api$resendConfirmationCodeRequestEncoder(x)));
		case 'RequestForgotPassword':
			var x = v.a;
			return $elm$core$Maybe$Just(
				_Utils_Tuple2(
					'requestForgotPassword',
					$author$project$Proto$Api$forgotPasswordRequestEncoder(x)));
		case 'RequestConfirmForgotPassword':
			var x = v.a;
			return $elm$core$Maybe$Just(
				_Utils_Tuple2(
					'requestConfirmForgotPassword',
					$author$project$Proto$Api$confirmForgotPasswordRequestEncoder(x)));
		case 'RequestSignIn':
			var x = v.a;
			return $elm$core$Maybe$Just(
				_Utils_Tuple2(
					'requestSignIn',
					$author$project$Proto$Api$signInRequestEncoder(x)));
		default:
			var x = v.a;
			return $elm$core$Maybe$Just(
				_Utils_Tuple2(
					'requestTokenRefresh',
					$author$project$Proto$Api$tokenRefreshRequestEncoder(x)));
	}
};
var $author$project$Proto$Api$authRequestEncoder = function (v) {
	return $elm$json$Json$Encode$object(
		A2(
			$elm$core$List$filterMap,
			$elm$core$Basics$identity,
			_List_fromArray(
				[
					$author$project$Proto$Api$authRequestSelectEncoder(v.authRequestSelect)
				])));
};
var $author$project$Proto$Api$AuthResponse = function (authResponseSelect) {
	return {authResponseSelect: authResponseSelect};
};
var $author$project$Proto$Api$AuthResponseSelectUnspecified = {$: 'AuthResponseSelectUnspecified'};
var $author$project$Proto$Api$ResponseConfirmForgotPassword = function (a) {
	return {$: 'ResponseConfirmForgotPassword', a: a};
};
var $author$project$Proto$Api$ResponseConfirmSignUp = function (a) {
	return {$: 'ResponseConfirmSignUp', a: a};
};
var $author$project$Proto$Api$ResponseForgotPassword = function (a) {
	return {$: 'ResponseForgotPassword', a: a};
};
var $author$project$Proto$Api$ResponseSignIn = function (a) {
	return {$: 'ResponseSignIn', a: a};
};
var $author$project$Proto$Api$ResponseSignUp = function (a) {
	return {$: 'ResponseSignUp', a: a};
};
var $author$project$Proto$Api$ResponseTokenRefresh = function (a) {
	return {$: 'ResponseTokenRefresh', a: a};
};
var $author$project$Proto$Api$ConfirmForgotPasswordResponse = {};
var $tiziano88$elm_protobuf$Protobuf$decode = $elm$json$Json$Decode$succeed;
...
var $author$project$Proto$Api$confirmForgotPasswordResponseDecoder = $elm$json$Json$Decode$lazy(
	function (_v0) {
		return $tiziano88$elm_protobuf$Protobuf$decode($author$project$Proto$Api$ConfirmForgotPasswordResponse);
	});
var $author$project$Proto$Api$ConfirmSignUpResponse = {};
var $author$project$Proto$Api$confirmSignUpResponseDecoder = $elm$json$Json$Decode$lazy(
	function (_v0) {
		return $tiziano88$elm_protobuf$Protobuf$decode($author$project$Proto$Api$ConfirmSignUpResponse);
	});
var $author$project$Proto$Api$ForgotPasswordResponse = F2(
	function (codeDeliveryType, codeDeliveryDestination) {
		return {codeDeliveryDestination: codeDeliveryDestination, codeDeliveryType: codeDeliveryType};
	});
var $tiziano88$elm_protobuf$Protobuf$field = $elm$json$Json$Decode$map2($elm$core$Basics$apR);
var $tiziano88$elm_protobuf$Protobuf$withDefault = F2(
...
var $tiziano88$elm_protobuf$Protobuf$required = F4(
	function (name, decoder, _default, d) {
		return A2(
...
var $author$project$Proto$Api$forgotPasswordResponseDecoder = $elm$json$Json$Decode$lazy(
	function (_v0) {
		return A4(
			...
			A4(
				...
				$elm$json$Json$Decode$string,
				'',
				$tiziano88$elm_protobuf$Protobuf$decode($author$project$Proto$Api$ForgotPasswordResponse)));
	});
var $author$project$Proto$Api$SignInResponse = F2(
	function (token, refreshToken) {
		return {refreshToken: refreshToken, token: token};
	});
var $author$project$Proto$Api$signInResponseDecoder = $elm$json$Json$Decode$lazy(
	function (_v0) {
		return A4(
			$tiziano88$elm_protobuf$Protobuf$required,
			'refreshToken',
			...
			A4(
				...
				$elm$json$Json$Decode$string,
				'',
				$tiziano88$elm_protobuf$Protobuf$decode($author$project$Proto$Api$SignInResponse)));
	});
var $author$project$Proto$Api$SignUpResponse = F2(
	function (codeDeliveryType, codeDeliveryDestination) {
		return {codeDeliveryDestination: codeDeliveryDestination, codeDeliveryType: codeDeliveryType};
	});
var $author$project$Proto$Api$signUpResponseDecoder = $elm$json$Json$Decode$lazy(
	function (_v0) {
		return A4(
			$tiziano88$elm_protobuf$Protobuf$required,
			'codeDeliveryDestination',
			...
			A4(
				...
				$elm$json$Json$Decode$string,
				'',
				$tiziano88$elm_protobuf$Protobuf$decode($author$project$Proto$Api$SignUpResponse)));
	});
var $author$project$Proto$Api$TokenRefreshResponse = function (token) {
	return {token: token};
};
var $author$project$Proto$Api$tokenRefreshResponseDecoder = $elm$json$Json$Decode$lazy(
	function (_v0) {
		return A4(
			$tiziano88$elm_protobuf$Protobuf$required,
			'token',
			$elm$json$Json$Decode$string,
			'',
			$tiziano88$elm_protobuf$Protobuf$decode($author$project$Proto$Api$TokenRefreshResponse));
	});
var $author$project$Proto$Api$authResponseSelectDecoder = $elm$json$Json$Decode$lazy(
	function (_v0) {
		return $elm$json$Json$Decode$oneOf(
			_List_fromArray(
				[
					...
					$author$project$Proto$Api$ResponseSignUp,
					A2($elm$json$Json$Decode$field, 'responseSignUp', $author$project$Proto$Api$signUpResponseDecoder)),
					A2(
					$elm$json$Json$Decode$map,
					$author$project$Proto$Api$ResponseConfirmSignUp,
					A2($elm$json$Json$Decode$field, 'responseConfirmSignUp', $author$project$Proto$Api$confirmSignUpResponseDecoder)),
					A2(
					$elm$json$Json$Decode$map,
					$author$project$Proto$Api$ResponseForgotPassword,
					A2($elm$json$Json$Decode$field, 'responseForgotPassword', $author$project$Proto$Api$forgotPasswordResponseDecoder)),
					A2(
					$elm$json$Json$Decode$map,
					$author$project$Proto$Api$ResponseConfirmForgotPassword,
					A2($elm$json$Json$Decode$field, 'responseConfirmForgotPassword', $author$project$Proto$Api$confirmForgotPasswordResponseDecoder)),
					A2(
					$elm$json$Json$Decode$map,
					$author$project$Proto$Api$ResponseSignIn,
					A2($elm$json$Json$Decode$field, 'responseSignIn', $author$project$Proto$Api$signInResponseDecoder)),
					A2(
					$elm$json$Json$Decode$map,
					$author$project$Proto$Api$ResponseTokenRefresh,
					A2($elm$json$Json$Decode$field, 'responseTokenRefresh', $author$project$Proto$Api$tokenRefreshResponseDecoder)),
					$elm$json$Json$Decode$succeed($author$project$Proto$Api$AuthResponseSelectUnspecified)
				]));
	});
var $author$project$Proto$Api$authResponseDecoder = $elm$json$Json$Decode$lazy(
	function (_v0) {
		return A2(
			$tiziano88$elm_protobuf$Protobuf$field,
			$author$project$Proto$Api$authResponseSelectDecoder,
			$tiziano88$elm_protobuf$Protobuf$decode($author$project$Proto$Api$AuthResponse));
	});
...
var $author$project$Api$ErrorJsonDecode = function (a) {
	return {$: 'ErrorJsonDecode', a: a};
};
var $author$project$Api$ErrorResponse = function (a) {
	return {$: 'ErrorResponse', a: a};
};
var $author$project$Api$ErrorUnauthorized = {$: 'ErrorUnauthorized'};
var $elm$json$Json$Decode$decodeString = _Json_runOnString;
var $author$project$Api$resultJson = F2(
				...
				if (_v2.$ === 'Just') {
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								prevState: $author$project$Main$PrevRequest(req)
							}),
						A3(
							...
							$author$project$Api$AuthRequest(
								$author$project$Proto$Api$AuthRequest(
									$author$project$Proto$Api$RequestTokenRefresh(
				...
				case 'BadStatus_':
					...
					return $elm$core$String$concat(
						_List_fromArray(
							[
								'BadStatus { status = ',
								$elm$core$String$fromInt(meta.statusCode),
								', body = ',
								body,
								'}'
							]));
...
var $author$project$Main$signInAndReturn = F4(
	function (model, authToken, token, refreshToken) {
		var model_ = _Utils_update(
			model,
			{authToken: authToken, prevState: $author$project$Main$PrevNone});
		var cmdStoreTokens = function () {
			if (refreshToken.$ === 'Just') {
				var refreshToken_ = refreshToken.a;
				return $author$project$Main$storeTokens(
					_Utils_Tuple2(token, refreshToken_));
			} else {
				return $author$project$Main$storeToken(token);
			}
		}();
		var _v0 = model.prevState;
		if (_v0.$ === 'PrevRequest') {
			var req = _v0.a;
			return _Utils_Tuple2(
				model_,
...
var $author$project$Page$ConfirmSignUp$update = F2(
	function (msg, model) {
				...
				if (m.$ === 'Submit') {
					return _Utils_Tuple2(
						...
						A3(
							...
							$author$project$Api$AuthRequest(
								$author$project$Proto$Api$AuthRequest(
									$author$project$Proto$Api$RequestSignUp(model.signUpModel.params)))));
				} else {
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								signUpModel: A2($author$project$Page$SignUp$update, m, model.signUpModel)
							}),
						$elm$core$Platform$Cmd$none);
				}
				...
				if (m.$ === 'Submit') {
					return _Utils_Tuple2(
						...
						A3(
							...
							$author$project$Api$AuthRequest(
								$author$project$Proto$Api$AuthRequest(
									$author$project$Proto$Api$RequestForgotPassword(model.forgotPasswordModel)))));
				} else {
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								forgotPasswordModel: A2($author$project$Page$ForgotPassword$update, m, model.forgotPasswordModel)
							}),
						$elm$core$Platform$Cmd$none);
				}
			case 'ConfirmForgotPasswordMsg':
				var m = msg.a;
				if (m.$ === 'Submit') {
					return _Utils_Tuple2(
						model,
						A3(
							...
							$author$project$Api$AuthRequest(
								$author$project$Proto$Api$AuthRequest(
									$author$project$Proto$Api$RequestConfirmForgotPassword(model.confirmForgotPasswordModel.params)))));
				} else {
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								confirmForgotPasswordModel: A2($author$project$Page$ConfirmForgotPassword$update, m, model.confirmForgotPasswordModel)
							}),
						$elm$core$Platform$Cmd$none);
				}
			case 'ApiResponse':
...
var $author$project$Main$ConfirmForgotPasswordMsg = function (a) {
	return {$: 'ConfirmForgotPasswordMsg', a: a};
};
var $author$project$Main$ConfirmSignUpMsg = function (a) {
	return {$: 'ConfirmSignUpMsg', a: a};
};
...
var $author$project$Page$ConfirmForgotPassword$ChangeConfirmationCode = function (a) {
	return {$: 'ChangeConfirmationCode', a: a};
};
var $author$project$Page$ConfirmForgotPassword$ChangePassword = function (a) {
	return {$: 'ChangePassword', a: a};
};
var $author$project$Page$ConfirmForgotPassword$ChangeShowPassword = {$: 'ChangeShowPassword'};
var $author$project$Page$ConfirmForgotPassword$ChangeUsername = function (a) {
	return {$: 'ChangeUsername', a: a};
};
var $author$project$Page$ConfirmForgotPassword$Submit = {$: 'Submit'};
...
var $author$project$Page$ConfirmForgotPassword$view = F2(
	function (msg, model) {
		var form = _List_fromArray(
			[
				...
				_List_Nil,
				{
					...
					onChange: A2($elm$core$Basics$composeL, msg, $author$project$Page$ConfirmForgotPassword$ChangeUsername),
				...
				_List_Nil,
				{
					label: A2(
						$mdgriffith$elm_ui$Element$Input$labelLeft,
						_List_Nil,
						$mdgriffith$elm_ui$Element$text('Confirmation code')),
					onChange: A2($elm$core$Basics$composeL, msg, $author$project$Page$ConfirmForgotPassword$ChangeConfirmationCode),
					placeholder: $elm$core$Maybe$Nothing,
				...
				_List_Nil,
				{
					...
					onChange: A2($elm$core$Basics$composeL, msg, $author$project$Page$ConfirmForgotPassword$ChangePassword),
					placeholder: $elm$core$Maybe$Nothing,
				...
				_List_Nil,
				{
					...
					onChange: A2(
						...
						msg,
						function (_v1) {
							return $author$project$Page$ConfirmForgotPassword$ChangeShowPassword;
						})
				}),
				A2(
				...
				$author$project$Style$submitButton,
				{
					...
					onPress: $elm$core$Maybe$Just(
						msg($author$project$Page$ConfirmForgotPassword$Submit))
				})
			]);
		return A2(
				...
				if (_v0.$ === 'Just') {
					...
					return A2(
						...
						A2(
							$mdgriffith$elm_ui$Element$el,
							_List_Nil,
							$mdgriffith$elm_ui$Element$text('I sent the confirmation code to `' + (res.codeDeliveryDestination + ('` via  ' + (res.codeDeliveryType + '.'))))),
						form);
				} else {
					return form;
				}
...
var $author$project$Page$ConfirmSignUp$ChangeCode = function (a) {
			...
			[
				...
				_List_Nil,
				{
					label: A2(
						...
						_List_Nil,
						$mdgriffith$elm_ui$Element$text('Username')),
					onChange: A2($elm$core$Basics$composeL, msg, $author$project$Page$ConfirmSignUp$ChangeName),
					placeholder: $elm$core$Maybe$Nothing,
					text: model.params.username
				}),
				A2(
				...
				_List_Nil,
				{
					label: A2(
						...
						_List_Nil,
						$mdgriffith$elm_ui$Element$text('Confirmation code')),
					onChange: A2($elm$core$Basics$composeL, msg, $author$project$Page$ConfirmSignUp$ChangeCode),
					placeholder: $elm$core$Maybe$Nothing,
					text: model.params.confirmationCode
				}),
				A2(
...
var $author$project$Page$ForgotPassword$ChangeName = function (a) {
	return {$: 'ChangeName', a: a};
};
var $author$project$Page$ForgotPassword$Submit = {$: 'Submit'};
var $author$project$Page$ForgotPassword$view = F2(
	function (msg, model) {
		return A2(
			$mdgriffith$elm_ui$Element$column,
			$author$project$Style$mainColumn,
				...
				[
					...
					_List_Nil,
					{
						label: A2(
							...
							_List_Nil,
							$mdgriffith$elm_ui$Element$text('Username')),
						onChange: A2($elm$core$Basics$composeL, msg, $author$project$Page$ForgotPassword$ChangeName),
						placeholder: $elm$core$Maybe$Nothing,
						text: model.username
					}),
					A2(
					...
					$author$project$Style$submitButton,
					{
						label: $mdgriffith$elm_ui$Element$text('Submit'),
						onPress: $elm$core$Maybe$Just(
							msg($author$project$Page$ForgotPassword$Submit))
					})
				]));
	});
...
var $author$project$Page$ResendConfirm$Submit = {$: 'Submit'};
var $author$project$Page$ResendConfirm$view = F2(
	function (msg, model) {
		return A2(
			$mdgriffith$elm_ui$Element$column,
			$author$project$Style$mainColumn,
				...
				[
					...
					_List_Nil,
					{
						label: A2(
							...
							_List_Nil,
							$mdgriffith$elm_ui$Element$text('Username')),
						onChange: A2($elm$core$Basics$composeL, msg, $author$project$Page$ResendConfirm$ChangeName),
						placeholder: $elm$core$Maybe$Nothing,
						text: model.username
					}),
					A2(
					...
					$author$project$Style$submitButton,
					{
						label: $mdgriffith$elm_ui$Element$text('Submit'),
						onPress: $elm$core$Maybe$Just(
							msg($author$project$Page$ResendConfirm$Submit))
					})
				]));
	});
var $author$project$Page$SignIn$ChangePassword = function (a) {
	return {$: 'ChangePassword', a: a};
};
var $author$project$Page$SignIn$ChangeShowPassword = {$: 'ChangeShowPassword'};
				...
				[
					...
					_List_Nil,
					{
						label: A2(
							...
							_List_Nil,
							$mdgriffith$elm_ui$Element$text('Username')),
						onChange: A2($elm$core$Basics$composeL, msg, $author$project$Page$SignIn$ChangeUsername),
						placeholder: $elm$core$Maybe$Nothing,
						text: model.params.username
					}),
					A2(
					...
					_List_Nil,
					{
						...
						onChange: A2($elm$core$Basics$composeL, msg, $author$project$Page$SignIn$ChangePassword),
						placeholder: $elm$core$Maybe$Nothing,
						show: model.showPassword,
						text: model.params.password
					}),
					...
					_List_Nil,
					{
						...
						onChange: A2(
							...
							msg,
							function (_v0) {
								return $author$project$Page$SignIn$ChangeShowPassword;
							})
					}),
					A2(
					$mdgriffith$elm_ui$Element$Input$button,
...
var $author$project$Page$SignUp$ChangeShowPassword = {$: 'ChangeShowPassword'};
var $author$project$Page$SignUp$ChangeUsername = function (a) {
	return {$: 'ChangeUsername', a: a};
};
...
var $author$project$Page$SignUp$view = F2(
	function (msg, model) {
		return A2(
			$mdgriffith$elm_ui$Element$column,
			$author$project$Style$mainColumn,
				...
				[
					...
					_List_Nil,
					{
						label: A2(
							...
							_List_Nil,
							$mdgriffith$elm_ui$Element$text('Username')),
						onChange: A2($elm$core$Basics$composeL, msg, $author$project$Page$SignUp$ChangeUsername),
						placeholder: $elm$core$Maybe$Nothing,
						text: model.params.username
					}),
					A2(
					...
					_List_Nil,
					{
						...
						onChange: A2($elm$core$Basics$composeL, msg, $author$project$Page$SignUp$ChangeEmail),
						placeholder: $elm$core$Maybe$Nothing,
					...
					_List_Nil,
					{
						label: A2(
							...
							_List_Nil,
							$mdgriffith$elm_ui$Element$text('Password')),
						onChange: A2($elm$core$Basics$composeL, msg, $author$project$Page$SignUp$ChangePassword),
						placeholder: $elm$core$Maybe$Nothing,
						show: model.showPassword,
						text: model.params.password
					}),
					...
					_List_Nil,
					{
						...
						onChange: A2(
							...
							msg,
							function (_v0) {
								return $author$project$Page$SignUp$ChangeShowPassword;
							})
					}),
					A2(
					$mdgriffith$elm_ui$Element$Input$button,
...
var $author$project$Main$content = function (model) {
	...
	switch (_v0.$) {
		case 'SignUp':
			return A2($author$project$Page$SignUp$view, $author$project$Main$SignUpMsg, model.signUpModel);
		case 'ConfirmSignUp':
			return A2($author$project$Page$ConfirmSignUp$view, $author$project$Main$ConfirmSignUpMsg, model.confirmSignUpModel);
		case 'ResendConfirm':
			return A2($author$project$Page$ResendConfirm$view, $author$project$Main$ResendConfirmMsg, model.resendConfirmModel);
		case 'SignIn':
			return A2($author$project$Page$SignIn$view, $author$project$Main$SignInMsg, model.signInModel);
		case 'ForgotPassword':
							...
							return A2(
								...
								function (refreshToken) {
									return $elm$json$Json$Decode$succeed(
										{refreshToken: refreshToken, token: token, windowHeight: windowHeight, windowWidth: windowWidth});
								},
								A2(
									$elm$json$Json$Decode$field,
									'refreshToken',
